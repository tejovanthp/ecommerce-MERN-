         ...
         <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-12">
            ...
            <div className="flex-1 max-w-2xl relative group">
               <input 
                 ...
                 className="w-full bg-white dark:bg-slate-900 text-slate-950 dark:text-white px-8 py-6 rounded-[2.5rem] font-black text-lg shadow-2xl outline-none focus:ring-8 focus:ring-red-500/20 border-none transition-all"
               />
               <i className="fa-solid fa-magnifying-glass absolute right-8 top-1/2 -translate-y-1/2 text-slate-400 text-xl group-hover:text-red-500 transition-colors"></i>
            </div>
         </div>
